...
//        withTestApplication({ configure(dataSource, changeLogger, adminUsername, adminPassword) }) {
...
//
//    @Test
//    fun testIndexGetPageWithEmptyData() {
//        withTestApplication({ configure(dataSource, changeLogger, adminUsername, adminPassword) }) {
//            handleRequest(
//                method = HttpMethod.Get,
//                uri = "/",
...
//</head>
//<body>
//<div id="loaded_content" style="font-size: 4em;"><div style="color:#FFFFFF;"></div></div>
//</body>
//<script>
...
//
//    @Test
//    fun testIndexGetPageWithColorSetButNoText() {
//        colorFile.writeText("FF00FF")
//        withTestApplication({ configure(dataSource, changeLogger, adminUsername, adminPassword) }) {
//            handleRequest(
//                method = HttpMethod.Get,
//                uri = "/",
...
//</head>
//<body>
//<div id="loaded_content" style="font-size: 4em;"><div style="color:#FF00FF;"></div></div>
//</body>
//<script>
//function loadContent() {
//    var xhr = new XMLHttpRequest();
...
//
//    @Test
//    fun testIndexGetPageWithoutColorSetButText() {
//        contentFile.writeText("Some Content")
//        withTestApplication({ configure(dataSource, changeLogger, adminUsername, adminPassword) }) {
//            handleRequest(
//                method = HttpMethod.Get,
//                uri = "/",
...
//</head>
//<body>
//<div id="loaded_content" style="font-size: 4em;"><div style="color:#FFFFFF;">Some Content</div></div>
//</body>
//<script>
//function loadContent() {
//    var xhr = new XMLHttpRequest();
...
//
//    @Test
//    fun testIndexGetPageWithColorAndTextSet() {
//        colorFile.writeText("FF00AA")
//        contentFile.writeText("Some Content")
//        withTestApplication({ configure(dataSource, changeLogger, adminUsername, adminPassword) }) {
//            handleRequest(
//                method = HttpMethod.Get,
...
//</head>
//<body>
//<div id="loaded_content" style="font-size: 4em;"><div style="color:#FF00AA;">Some Content</div></div>
//</body>
//<script>
//function loadContent() {
//    var xhr = new XMLHttpRequest();
...
//
//    @Test
//    fun testIndexGetPageWithColorAndTextSetButXSS() {
//        colorFile.writeText("FF00AA;\"><script>alert('Oha');</script>")
//        contentFile.writeText("<script>alert('P0wned');</script>")
//        withTestApplication({ configure(dataSource, changeLogger, adminUsername, adminPassword) }) {
//            handleRequest(
//                method = HttpMethod.Get,
//                uri = "/",
...
//</head>
//<body>
//<div id="loaded_content" style="font-size: 4em;"><div style="color:#FFFFFF;">&lt;script&gt;alert(&#x27;P0wned&#x27;);&lt;/script&gt;</div></div>
//</body>
//<script>
//function loadContent() {
//    var xhr = new XMLHttpRequest();
...
//
//    @Test
//    fun testIndexGetPageWithColorAndTextSetButXSS2() {
//        colorFile.writeText(";\"><script>alert('Oha');</script>")
//        contentFile.writeText("<script>alert('P0wned');</script>")
//        withTestApplication({ configure(dataSource, changeLogger, adminUsername, adminPassword) }) {
//            handleRequest(
//                method = HttpMethod.Get,
